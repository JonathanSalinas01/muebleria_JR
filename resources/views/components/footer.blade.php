<div>
    ...
    <footer class="bg-marron-footer">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="{{ asset('images/logo_muebleria.png') }}" class="h-25 me-3" alt="Logo de la muebleria" />
                        <span class="text-heading self-center text-2xl font-semibold whitespace-nowrap"></span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div class="flex flex-col items-center">
                        <svg class="hidden md:block size-12 text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5" />
                        </svg>
                        <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Nuestra oficina</h2>
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline">Garupá, Altos Gonzales</a>
                            </li>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Datos de contacto</h2>
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline ">3764-xxxxxx</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex flex-col items-center">
                        <svg class="hidden md:block size-12 text-gray-900" aria-hidden="true"
                        ...
                        <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Email</h2>
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline">jorgeferreyra12@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-body sm:text-center">© {{ now()->year }} <a href="#"
                        class="hover:underline">Jonathan Salinas™</a>. All Rights Reserved.
                </span>
