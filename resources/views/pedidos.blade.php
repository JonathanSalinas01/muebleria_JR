...
<body class="bg-azul-oscuro min-h-screen flex flex-col">
    ...
    <main class="w-full lg:w-2/3 mx-auto rounded-2xl shadow-lg mb-10 mt-10 flex-grow">
        ...
        @endif
        <form class="p-3" action="{{ route('pedido.enviar') }}" method="POST">
            @csrf
            <div class="grid gap-6 mb-6">
                <div>
                    <label for="nombre" class="block mb-2.5 text-amber-50 text-md font-bold text-heading">Nombre
                        Completo</label>
            ...
            <div class="mb-6">
                <label for="email" class="block mb-2.5 text-amber-50 text-md font-bold text-heading">Correo
                    Electrónico</label>
            ...
            <label for="message" class="block mb-2.5 text-amber-50 text-md font-bold text-heading">Escribe tu pedido o
                cotización</label>
            <textarea id="message" rows="4" name="mensaje"
